...
## What This Herb Does
- **Therapeutic Focus**: Fluid Retention and Edema, Urinary Health, Digestive Health, Skin Heat and Toxic Swellings
- **TCM Actions**: Promotes Urination and Reduces Edema, Drains Water from the Skin and Flesh, Opens the Water Pathways
...
- **Explanation**: When the Spleen's ability to transform and transport fluids is weakened, Dampness accumulates and overflows into the skin and muscles, causing generalized edema. Fu Ling Pi's sweet, bland, and neutral nature gently drains this surface-level water accumulation through the Lung and Kidney channels without further injuring already-weakened Spleen Qi. Its affinity for the skin layer makes it especially suited when Dampness manifests as puffiness in the face, limbs, and body surface rather than deep organ-level fluid retention.
...
- **Why it Helps**: Fu Ling Pi specifically targets fluid trapped at the body's surface. As the outer skin of the Poria fungus, it follows the classical principle of 'using the skin to treat the skin' (以皮行皮), meaning it has a natural affinity for the superficial tissue layers where edema fluid accumulates. It enters the Lung, Spleen, and Kidney channels, addressing all three organ systems that regulate water movement. Its bland taste gives it a gentle 'seeping' quality that percolates Dampness downward and out through urination, without being harsh or drying. Crucially, unlike many diuretics, Fu Ling Pi drains water without depleting the body's Qi, making it safe for patients who are already debilitated.
...
## Common Herb Pairs
### Da Fu Pi (Ratio: 1:1 (equal parts, typically 9-15g each))
- **Description**: Fu Ling Pi drains Dampness from the skin surface through urination, while Da Fu Pi (Areca husk) moves Qi downward and reduces abdominal distension. Together they address both the fluid stagnation and the Qi stagnation that accompany edema, following the principle that 'when Qi moves, water moves.' Both are 'skin' herbs, enhancing their combined affinity for the body's surface layer.
- **When to Use**: Generalized edema with abdominal bloating and distension, as seen in the classical Wu Pi San (Five Peel Powder).

### Sheng Jiang Pi (Ratio: 1:1 (equal parts, typically 9-15g each))
- **Description**: Sheng Jiang Pi (fresh ginger peel) warms and disperses water at the skin level while harmonizing the Spleen. Fu Ling Pi provides bland, percolating diuresis. Together they address surface edema from both directions: Sheng Jiang Pi pushes outward while Fu Ling Pi drains downward, and both specifically target the skin layer.
...
### Sang Bai Pi (Ratio: 1:1 (equal parts, typically 9-15g each))
- **Description**: Sang Bai Pi (Mulberry root bark) descends Lung Qi and opens the water passages from above, while Fu Ling Pi drains Dampness downward through the Kidney and Bladder channels. Together they create a top-to-bottom water-moving pathway: the Lungs regulate the downward flow and the Kidneys excrete it. This pairing treats edema by addressing the Lung's role in fluid distribution.
...
1. **[Diuretic activity of some fractions of the epidermis of Poria cocos (Preclinical, 2013)](https://doi.org/10.1016/j.jep.2013.10.043)**
   *Journal: Feng YL, Lei P, Tian T, Yin L, Chen DQ, Chen H, Mei Q, Zhao YY, Lin RC. Journal of Ethnopharmacology, 2013, 150(3): 1114-1118.*
...
2. **[Poria cocos: traditional uses, triterpenoid components and their renoprotective pharmacology (Review, 2025)](https://doi.org/10.1038/s41401-024-01404-7)**
   *Journal: Guo ZY, Wu X, Zhang SJ, Yang JH, Miao H, Zhao YY. Acta Pharmacologica Sinica, 2025, 46(4): 836-851.*
...
3. **[Molecular basis for Poria cocos mushroom polysaccharide used as an antitumour drug in China (Review, 2019)](https://doi.org/10.1111/jcmm.13564)**
   *Journal: Li X, He Y, Zeng P, et al. Journal of Cellular and Molecular Medicine, 2019, 23(1): 4-20.*
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/herbs/fu-ling-pi](https://www.meandqi.com/knowledge-base/herbs/fu-ling-pi)*