...
**Category**: Substances for external application (外用药), Herbs that draw out toxins, resolve putrefaction, and generate flesh (拔毒化腐生肌药)  
**Scientific Name**: Smithsonite (ZnCO₃)  
**Pharmaceutical Name**: Calamina  
**Toxicity**: Non-toxic  
...
## What This Herb Does
- **Therapeutic Focus**: Eye Health and Vision, Skin Health, Skin and Wound Care
- **TCM Actions**: Clears toxins and brightens the eyes, Brightens the Eyes and Removes Visual Obstructions, Dries Dampness and Stops Itching, Promotes Tissue Regeneration and Heals Sores, Stops Bleeding
...
## Dosage & Preparation
- **Standard Dosage**: External use only, appropriate amount. Not taken internally.
- **Maximum Dosage**: External use only; no maximum gram dosage applies. Use an appropriate amount as needed for the affected area. Not for internal use under any circumstances.
- **Dosage Notes**: Lu Gan Shi is used exclusively as an external medicine. For eye conditions, it must be processed by water-levigation (水飞, shui fei) to produce an ultra-fine powder that is smooth and non-irritating before being applied to the eyes. For skin conditions such as eczema, damp sores, or non-healing ulcers, the calcined and levigated powder can be applied directly, mixed with sesame oil as a paste, or combined with other medicinals. When used for eye diseases, it is often combined with Bing Pian (borneol), Peng Sha (borax), or Huang Lian (Coptis). For weeping sores and ulcers, it is commonly paired with Er Cha (Acacia Catechu) or Long Gu (Dragon Bone). The amount used depends on the size of the affected area.
- **Preparation**: Lu Gan Shi must be processed before use and is never taken internally. The standard processing method (炮制) involves calcination (煅): the raw mineral is placed in a crucible and heated in a smokeless fire until red-hot, then immediately quenched in water (or in a decoction of Huang Lian/Coptis, or in San Huang Tang made from Huang Lian, Huang Bai, and Da Huang). This calcination-quenching cycle is repeated 3 to 9 times. The resulting material is then processed by water-levigation (水飞, shui fei): the calcined pieces are ground in water, the coarse sediment is discarded, and the fine suspended particles are collected, filtered, and dried. This produces an ultra-fine, smooth powder suitable for topical use, especially for delicate eye applications. The Huang Lian decoction quenching adds additional heat-clearing and antimicrobial properties to the finished product.

---

## Processing Methods
### Du&#xE0;n L&#xFA; G&#x101;n Sh&#xED; (&#x7145;&#x7089;&#x7518;&#x77F3;)
- **Processing Method**: The raw mineral is calcined (fired in a crucible until red-hot), then quenched in water. This calcination-quenching cycle may be repeated 3 to 4 times. The resulting suspension is collected, the coarse residue discarded, and the fine powder dried. For ophthalmological use, the powder is further water-levigated (水飞 shuǐ fēi) to produce an extremely fine, silky powder safe for eye application.
- **How it Changes Properties**: Calcination transforms the main component from zinc carbonate (ZnCO₃) into zinc oxide (ZnO), which has stronger astringent, antiseptic, and tissue-protective properties. The resulting powder is much finer and less irritating, making it safe for use on sensitive tissues including the eyes. The thermal nature remains neutral.
- **When to Use**: This is the standard form used in all clinical applications. The raw, uncalcined mineral is never applied directly. The calcined and water-levigated form is essential for eye applications to avoid corneal damage from coarse particles.

### Hu&#xE1;ng Li&#xE1;n Shu&#x1D0; Zh&#xEC; L&#xFA; G&#x101;n Sh&#xED; (&#x9EC4;&#x8FDE;&#x6C34;&#x5236;&#x7089;&#x7518;&#x77F3;)
- **Processing Method**: After calcination, the hot mineral is quenched in a Huang Lian (Coptis) decoction instead of plain water. This is repeated multiple times. The fine powder is then mixed with additional Huang Lian decoction, dried, and stored. The traditional ratio is approximately 12.5 jin of Huang Lian per 100 jin of calcined Lu Gan Shi powder.
- **How it Changes Properties**: The Huang Lian decoction imparts additional Heat-clearing and toxin-resolving properties from the berberine and other alkaloids in Coptis. This enhances the mineral's ability to address inflammatory and infected eye conditions compared to plain-water processing.
- **When to Use**: Preferred for eye disorders involving significant Heat, redness, and infection, such as acute conjunctivitis and infected eyelid margins. The added antimicrobial and anti-inflammatory properties of Huang Lian make this form stronger for Heat-pattern eye diseases.

### S&#x101;n Hu&#xE1;ng T&#x101;ng Zh&#xEC; L&#xFA; G&#x101;n Sh&#xED; (&#x4E09;&#x9EC4;&#x6C64;&#x5236;&#x7089;&#x7518;&#x77F3;)
- **Processing Method**: The mineral is calcined and then quenched in San Huang Tang, a decoction made from Huang Lian (Coptis), Huang Bai (Phellodendron), and Da Huang (Rhubarb). The process is repeated multiple times, and the final powder is water-levigated.
- **How it Changes Properties**: This processing adds stronger Heat-clearing and Dampness-drying properties compared to single-herb Huang Lian processing, as it incorporates three potent bitter, cold herbs. This version has enhanced anti-inflammatory and anti-infective capabilities.
- **When to Use**: Used for severe eye infections or skin conditions with significant Damp-Heat, such as badly infected weeping ulcers or severe purulent eye diseases.

---

## Common Herb Pairs
### Bing Pian (Ratio: Lu Gan Shi 15g : Bing Pian 0.3-1g (Bing Pian is used in small amounts due to its potency))
- **Description**: Lu Gan Shi astringes Dampness and promotes tissue regeneration while Bing Pian (Borneol) clears Heat, relieves pain, and prevents putrefaction. Together they create a topical preparation that both dries weeping lesions and provides cooling pain relief, while protecting against secondary infection.
...
### Er Cha (Ratio: Lu Gan Shi 30g : Er Cha 9g (approximately 3:1))
- **Description**: Lu Gan Shi dries Dampness and generates flesh while Er Cha (Catechu) astringes and promotes wound healing. The combination is particularly effective for genital sores and lower body ulcers, providing both moisture absorption and tissue regeneration.
...
1. **[Zinc Therapy in Dermatology: A Review (Review, 2014)](https://pubmed.ncbi.nlm.nih.gov/25120566/)**
   *Journal: Gupta M, Mahajan VK, Mehta KS, Chauhan PS. Dermatology Research and Practice. 2014; 2014: 709152.*
...
2. **[Analysis on Processing Mechanism of Calamine (Laboratory study, 2005)](https://pubmed.ncbi.nlm.nih.gov/16011284/)**
   *Journal: Zhongguo Zhong Yao Za Zhi (China Journal of Chinese Materia Medica). 2005; 30(13): 1003-1006.*
...
3. **[Processing Mechanism of Calamine (Laboratory study, 2010)](https://pubmed.ncbi.nlm.nih.gov/20815206/)**
   *Journal: Zhongguo Zhong Yao Za Zhi (China Journal of Chinese Materia Medica). 2010; 35(15): 1949-1952.*
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/herbs/lu-gan-shi](https://www.meandqi.com/knowledge-base/herbs/lu-gan-shi)*