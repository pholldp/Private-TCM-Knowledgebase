...
## What This Herb Does
- **Therapeutic Focus**: Digestive Health, Appetite Support, Bloating Relief, Children's Digestive Health
- **TCM Actions**: Strengthens the Spleen and Promotes Digestion, Strengthens the Spleen and Opens the Appetite, Descends Qi and Relieves Distension
...
- **When to Use**: Used when the primary goal is to actively promote digestion and reduce food stagnation, particularly when appetite is poor but there is no significant underlying Spleen deficiency. The standard choice for routine digestive prescriptions.

### Ji&#x101;o G&#x1D4; Y&#xE1; (&#x7126;&#x8C37;&#x82BD;)
- **Processing Method**: Stir-fried over high heat (武火) until the grains turn scorched brown, then lightly sprinkled with water and air-dried.
- **How it Changes Properties**: Charring produces a bitter, astringent quality on top of the original sweetness. The bitter taste helps dry dampness and the charring enhances the herb's ability to resolve stubborn food accumulation. However, the amylase enzymes are largely destroyed by the high heat, so the digestive mechanism shifts from enzymatic to thermal/Qi-based. The astringent quality also adds a mild ability to check diarrhea.
- **When to Use**: Used for more stubborn food accumulation (积滞不消) and for food stagnation accompanied by diarrhea. Part of the 'Jiao San Xian' trio (charred Shan Zha, Shen Qu, and Gu Ya/Mai Ya) used as a standard combination for food stagnation.

---

## Common Herb Pairs
### Mai Ya (Ratio: 1:1 (typically 10-15g each))
- **Description**: Mai Ya (Barley Sprout) and Gu Ya are the classic digestive pair, almost always used together. Mai Ya has stronger digestive power and can also soothe the Liver and regulate Qi, while Gu Ya is gentler and better at tonifying the Spleen. Together they complement each other: Mai Ya provides stronger starch-digesting action while Gu Ya ensures the Spleen is supported rather than drained. This pairing addresses food stagnation from grains and starchy foods more completely than either herb alone.
...
### Shan Zha (Ratio: 1:1 (typically 10-15g each))
- **Description**: Shan Zha (Hawthorn Fruit) is best at digesting meat and greasy foods, while Gu Ya handles starchy food stagnation. Together they cover the full spectrum of dietary excess. Shan Zha's sour taste also activates digestive secretions, while Gu Ya's sweet warmth supports the underlying Spleen function.
...
### Bai Zhu (Ratio: 1:1 to 2:1 Bai Zhu to Gu Ya)
...
### Sha Ren (Ratio: Sha Ren 3-6g : Gu Ya 10-15g)
- **Description**: Sha Ren (Amomum Fruit) is aromatic and warming, strongly activating the Spleen's transformation function and moving Qi to relieve bloating. Combined with Gu Ya, the aromatic quality of Sha Ren 'awakens' the Spleen while Gu Ya gently promotes digestion. Sha Ren also prevents tonifying herbs from causing stagnation, making this pair useful in complex formulas.
...
1. **[Antioxidant activity of extracts from foxtail millet (Setaria italica) — In vitro study, 2013](https://pubmed.ncbi.nlm.nih.gov/23904660/)**
   *Journal: Viswanath V et al., J Food Sci Technol, 2013*
...
2. **[Polyphenols from foxtail millet alleviate glucose and lipid homeostasis in diet-induced obese mice — Preclinical study, 2023](https://pubmed.ncbi.nlm.nih.gov/37548615/)**
   *Journal: J Sci Food Agric, 2023*
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/herbs/gu-ya](https://www.meandqi.com/knowledge-base/herbs/gu-ya)*