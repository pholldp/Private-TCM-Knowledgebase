# Yi Zhi Ren (益智仁)
**English Name**: Alpinia Fruit  
**Category**: Yang-tonifying herbs (补阳药)  
**Scientific Name**: Alpinia oxyphylla Miq.  
...
## What This Herb Does
- **Therapeutic Focus**: Urinary Health, Digestive Health, Kidney Health, Men's Reproductive Health
- **TCM Actions**: Warms the Kidneys and astringes essence to reduce urination, Warms the Middle Burner and Stops Diarrhea, Controls salivation, Secures Essence and Stops Seminal Emission
...
- **Clinical Signs & Symptoms**:
  - **Excessive Salivation**: Drooling or copious thin saliva
...
## Processing Methods
### Y&#xE1;n Y&#xEC; Zh&#xEC; R&#xE9;n (&#x76D0;&#x76CA;&#x667A;&#x4EC1;)
- **Processing Method**: The seeds are mixed with salt water (approximately 2kg salt per 100kg of herb), allowed to absorb briefly, then stir-fried over gentle heat until dry.
...
- **When to Use**: Preferred for Kidney-related conditions: frequent urination, nocturnal enuresis, seminal emission, and spermatorrhea. This is the standard form used in Suō Quán Wán and most urinary/reproductive prescriptions.

### Ch&#x1CE;o Y&#xEC; Zh&#xEC; R&#xE9;n (&#x7092;&#x76CA;&#x667A;&#x4EC1;)
- **Processing Method**: The whole fruit is dry-fried over high heat until the outer shell becomes dark brown and crispy, then the shell is removed and the inner seed is used.
- **How it Changes Properties**: Dry-frying is primarily a method for removing the outer shell rather than fundamentally changing the herb's properties. The seed retains its warm, pungent nature but may have slightly reduced aromatic volatility compared to the raw form.
- **When to Use**: A processing step mainly used to facilitate shell removal. The resulting seed can then be used directly (as the raw form for Spleen-warming purposes) or further processed with salt for Kidney indications.

---

## Common Herb Pairs
### Wu Yao (Ratio: 1:1 (equal parts, as in Su&#x14D; Qu&#xE1;n W&#xE1;n))
- **Description**: Yì Zhì Rén warms Kidney Yang and astringes to hold urine, while Wū Yào moves Qi and disperses cold from the Bladder and Kidney. Together they address both the Yang deficiency (root) and the Qi stagnation from cold (branch) that cause urinary frequency, creating the core mechanism of Suō Quán Wán.
...
### Bu Gu Zhi (Ratio: 1:1)
- **Description**: Both herbs warm Kidney Yang, but Bǔ Gǔ Zhī is stronger at tonifying Kidney Yang and also warms the Spleen to stop diarrhea. Together they provide a more powerful warming and consolidating effect on the lower body than either herb alone, addressing both seminal loss and early-morning diarrhea.
...
1. **[Comprehensive Review: Ethnopharmacological uses, phytochemistry, biological activities, and therapeutic applications of Alpinia oxyphylla Miquel (2018)]()**
   *Journal: Zhang Q, Zheng Y, Hu X, et al. Journal of Ethnopharmacology, 2018, 224: 149-168.*
...
2. **[Network Pharmacology Study: Neuroprotective Effects of A. oxyphylla on Alzheimer's Disease (2020)](https://pubmed.ncbi.nlm.nih.gov/32197305/)**
   *Journal: Xu J, Wang F, Guo J, et al. International Journal of Molecular Sciences, 2020, 21(6): 2218.*
...
3. **[Preclinical Study: Neuroprotective effect against glutamate-induced apoptosis in cortical neurons (2003)](https://pubmed.ncbi.nlm.nih.gov/12927364/)**
   *Journal: Yu X, An L, Wang Y, Zhao H, Gao C. Toxicology Letters, 2003, 144(2): 205-212.*
...
4. **[Preclinical Study: Protection against 6-OHDA-induced dopaminergic neuron damage in zebrafish Parkinson's disease model (2011)](https://pubmed.ncbi.nlm.nih.gov/21744117/)**
   *Journal: Li S, Tang D, Hou Y, et al. Journal of Ethnopharmacology, 2011, 141(1): 15-22.*
...
5. **[Preclinical Study: A. oxyphylla fruit extract ameliorates experimental autoimmune encephalomyelitis via Th1/Th17 regulation (2019)]()**
   *Journal: Huang KK, Lin MN, Hsu YL, et al. Evidence-Based Complementary and Alternative Medicine, 2019, 2019: 2471462.*
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/herbs/yi-zhi-ren](https://www.meandqi.com/knowledge-base/herbs/yi-zhi-ren)*