# Jiao Mu (椒目)
**English Name**: Prickly ash seed  
**Category**: Dampness-draining herbs (利水渗湿药)  
**Scientific Name**: Zanthoxylum bungeanum Maxim. or Zanthoxylum schinifolium Sieb. et Zucc.  
**Pharmaceutical Name**: Semen Zanthoxyli  
**Toxicity**: Slightly toxic  
**Temperature**: Cold | **Taste**: Bitter (苦 kǔ), Acrid / Pungent (辛 xīn)  
**Channels Entered**: Spleen, Urinary Bladder, Lungs  
...
## What This Herb Does
- **Therapeutic Focus**: Fluid Retention and Edema, Respiratory Health, Bloating Relief, Kidney and Bladder Health
- **TCM Actions**: Promotes Urination and Reduces Edema, Resolves Phlegm-Fluid Retention, Drains Water and Reduces Edema
...
- **When to Use**: This is the standard clinical form and most classical formulas specify using stir-fried Jiāo Mù. Preferred over the raw form for internal decoction to reduce potential digestive irritation and any mild toxicity.

### Y&#xE1;n Ji&#x101;o M&#xF9; (&#x76D0;&#x6912;&#x76EE;)
- **Processing Method**: Seeds are moistened with diluted salt water, then stir-fried over moderate heat until dry.
- **How it Changes Properties**: Salt processing enhances the herb's downward-directing properties and strengthens its entry into the Kidney channel. Salt is salty and descending by nature, guiding the herb's action more firmly toward the Kidneys and lower body, thereby boosting its diuretic effect and Kidney-supporting function.
- **When to Use**: When water retention is specifically associated with Kidney dysfunction, such as lower body edema, or when the herb is used for Kidney-related symptoms like tinnitus and deafness from Kidney deficiency, as historically referenced in the classical literature.

---

## Common Herb Pairs
### Fang Ji (Ratio: 1:1 (equal parts in the classical formula))
- **Description**: Jiāo Mù and Fáng Jǐ (Stephania root) form a powerful water-draining pair. Fáng Jǐ clears Dampness and Heat from the blood level and lower body, while Jiāo Mù drives water out specifically through the urinary pathway. Together they address both the blood-level stagnation and water-pathway blockage that trap fluid in the abdomen, making the pair more effective than either herb alone.
...
### Ting Li Zi (Ratio: 1:1 (equal parts))
- **Description**: Jiāo Mù drains water from below through the Bladder, while Tíng Lì Zǐ purges water from above by draining the Lungs and driving fluid downward. Together they address fluid congestion at both the upper (chest) and lower (abdomen) levels simultaneously.
...
### Da Huang (Ratio: 1:1 (equal parts in J&#x1D0; Ji&#x101;o L&#xEC; Hu&#xE1;ng W&#xE1;n))
- **Description**: Jiāo Mù directs water out through the front (urination) while Dà Huáng drives it out through the back (bowel movements). This classical 'front-and-back simultaneous drainage' strategy (前后分消) tackles severe fluid retention from multiple routes when gentler single-route approaches are insufficient.
...
### Sang Bai Pi (Ratio: S&#x101;ng B&#xE1;i P&#xED; 10g : Ji&#x101;o M&#xF9; 6g)
- **Description**: Sāng Bái Pí (Mulberry root bark) clears Lung Heat and directs Lung Qi downward, while Jiāo Mù drains fluid from below through the Bladder. Together they address wheezing from two directions: Sāng Bái Pí opens up the Lungs from above, while Jiāo Mù pulls accumulated fluid down and out through urination.
...
## Key Formulas
Ji Jiao Li Huang Wan, Shu Zao Yin Zi
...
### Special Populations
- **Pregnancy**: Jiao Mu should be used with caution during pregnancy. It has water-draining and downward-directing properties that could theoretically affect fluid balance. Its classification as slightly toxic also warrants caution. There is no specific classical prohibition for pregnancy, but given the lack of modern safety data in pregnant women, it is best avoided unless specifically prescribed by a qualified practitioner who determines the benefit outweighs the risk.
...
1. **[Phytochemical profiles and biological activity evaluation of Zanthoxylum bungeanum Maxim seed against asthma in murine models (Preclinical study, 2014)](https://pubmed.ncbi.nlm.nih.gov/24495470/)**
   *Journal: Tang W, Xie Q, Guan J, Jin S, Zhao Y. J Ethnopharmacol. 2014; 152(3): 444-450.*
...
2. **[Inhibitory effect of Zanthoxylum bungeanum seed oil on ovalbumin-induced lung inflammation in a murine model of asthma (Preclinical study, 2016)](https://pubmed.ncbi.nlm.nih.gov/27035565/)**
   *Journal: Wang JQ, Li XW, Liu M, Wang SC, Cao ZF. Mol Med Rep. 2016; 13(5): 4289-4302.*
...
3. **[Zanthoxylum bungeanum Seed Oil Attenuates LPS-Induced BEAS-2B Cell Activation and Inflammation by Inhibiting the TLR4/MyD88/NF-κB Signaling Pathway (In vitro study, 2021)](https://doi.org/10.1155/2021/2073296)**
   *Journal: Hou Y, et al. Evid Based Complement Alternat Med. 2021; 2021: 2073296.*
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/herbs/jiao-mu](https://www.meandqi.com/knowledge-base/herbs/jiao-mu)*