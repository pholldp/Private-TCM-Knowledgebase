...
**English Name**: Scutellaria and Talcum Decoction  
**Category**: Heat-clearing and Dampness-drying formulas  
**Dynasty/Source**: Wen Bing Tiao Bian (温病条辨), Volume 2, Middle Burner chapter (中焦篇), by Wu Jutong (吴鞠通)  
...
## Key Metadata
- **TCM Actions**: Clears Heat, Resolves Dampness, Promotes urination, Regulates Qi movement
- **Therapeutic Focus**: Digestive health, Fever management, Urinary health
- **Target Organs**: Spleen, Stomach, Small Intestine, Urinary Bladder, San Jiao (Triple Burner)
- **Patterns Addressed**: 
- **Conditions Treated**: Acute Gastroenteritis, Urinary Tract Infection, Chronic Gastritis, Typhoid Fever, Infectious Hepatitis, Pyelonephritis
- **Other Names**: 
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Huang Qin** | Baical skullcap root | *Main* | 9g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Lungs, Gallbladder, Spleen, Large Intestine, Small Intestine, Heart, Stomach | Clears Damp-Heat, particularly from the Middle Jiao. As the primary herb, it directly targets the Heat component that has become entangled with Dampness, using its bitter-cold nature to drain Heat downward. |
| **Hua Shi** | Talc | *Main* | 9g | Temp: Cold<br>Taste: Sweet (&#x7518; g&#x101;n), Bland (&#x6DE1; d&#xE0;n)<br>Affinity: Stomach, Urinary Bladder | Clears Heat and promotes urination, providing a downward drainage route for Damp-Heat through the Bladder. Its bland, slippery nature gives Dampness a pathway out of the body without damaging Yin. |
| **Zhu Ling** | Polyporus mushroom | *Enhancer* | 9g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n), Bland (&#x6DE1; d&#xE0;n)<br>Affinity: Kidneys, Urinary Bladder | Promotes urination and drains Dampness. Works alongside Hua Shi and Fu Ling Pi to strengthen the formula's ability to resolve Dampness through the urinary pathway. |
| **Fu Ling Pi** | Poria peel | *Enhancer* | 9g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n), Bland (&#x6DE1; d&#xE0;n)<br>Affinity: Lungs, Spleen, Kidneys | Promotes urination and leaches out Dampness. Fu Ling Pi (the skin of Poria) is specifically chosen over the whole Fu Ling because the skin has a stronger action of draining fluid from the surface and skin level, appropriate for body heaviness and aches. |
| **Da Fu Pi** | Areca peel | *Balancer* | 6g | Temp: Slightly Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Spleen, Stomach, Large Intestine, Small Intestine | Moves Qi and resolves Dampness in the Middle Jiao. By promoting the downward flow of Qi in the digestive tract, it helps the Spleen and Stomach resume their transport function, and prevents stagnation of fluids. |
| **Bai Dou Kou** | White Cardamom | *Balancer* | 3g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Aromatic (&#x82B3;&#x9999; f&#x101;ng xi&#x101;ng)<br>Affinity: Lungs, Spleen, Stomach | Aromatically transforms Dampness and moves Qi in the Middle Jiao. Its warm, aromatic nature counterbalances the cold properties of Huang Qin and Hua Shi, preventing the bitter-cold herbs from further obstructing the Spleen's transport function. |
| **Tong Cao** | Rice paper pith | *Deliverer* | 3g | Temp: Slightly Cool<br>Taste: Sweet (&#x7518; g&#x101;n), Bland (&#x6DE1; d&#xE0;n)<br>Affinity: Lungs, Stomach | Gently promotes urination and clears Heat through the water passages. Its bland, light nature helps guide the actions of the other herbs downward and outward through the urinary tract. |

---

## Scientific Research

1. [Huang Qin Hua Shi decoction for high-temperature- and high-humidity-induced cognitive-behavioral disorder in rats (Animal study, 2019)](https://doi.org/10.1177/0300060519875369) (*Luo Y, Yang M, Guo M, Zhong X, Hu Y. Journal of International Medical Research, 2019, 47(11): 5752–5766.*)
...
- **Best Time to Take**: Three times daily, taken warm, between meals (approximately 30–60 minutes before or after eating).
- **Typical Duration**: Acute use: typically 3–7 days, reassessed as symptoms resolve. Discontinue promptly once Damp-Heat signs clear.
- **Dietary Advice**: While taking this formula, avoid greasy, fried, and heavily rich foods, as these generate internal Dampness and directly counteract the formula's Dampness-resolving action. Cold and raw foods (ice cream, cold salads, chilled drinks) should also be minimized, as they impair Spleen function and hinder the transformation of Dampness. Alcohol and spicy-hot foods should be avoided, as they generate Damp-Heat internally.
Favour light, easily digestible foods: plain rice congee, mung bean soup, Job's tears (yi yi ren) porridge, winter melon, and lotus seed are all traditionally recommended during Damp-Heat conditions. Adequate warm water intake supports the formula's diuretic action in clearing Dampness through the urinary tract.

---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/huang-qin-hua-shi-tang](https://www.meandqi.com/knowledge-base/formulas/huang-qin-hua-shi-tang)*
