# Si Mo Tang (四磨汤)
**English Name**: Four Milled-Herb Decoction  
**Category**: Qi-regulating formulas, Qi-descending formulas  
**Dynasty/Source**: Chóng Dìng Yán Shì Jì Shēng Fāng (重訂嚴氏濟生方), Volume 2, by Yan Yonghe  
...
## Key Metadata
- **TCM Actions**: Moves Qi, Descends Qi, Soothes the Liver and Regulates Qi, Broadens the Chest and Dissipates Nodules, Supports the Upright and Dispels Pathogens
- **Therapeutic Focus**: Digestive Health, Bloating Relief, Respiratory Health, Stress-related digestive issues
- **Target Organs**: Liver, Lungs, Stomach, Spleen
- **Patterns Addressed**: 
- **Conditions Treated**: Dyspepsia, Chronic Constipation, Bronchial Asthma, Gastritis, Emphysema, Irritable Bowel Syndrome, Postoperative Ileus, Gastroesophageal Reflux Disease
- **Other Names**: Si Mo Yin (四磨饮, Four Milled-Herb Drink)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Wu Yao** | Lindera root | *Main* | 6 - 10g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Lungs, Spleen, Kidneys, Urinary Bladder | Warms and moves Qi throughout all channels, soothes the Liver, disperses stagnation, and relieves pain. As the primary herb, it directly addresses the root cause of Liver Qi stagnation from emotional injury. |
| **Chen Xiang** | Agarwood | *Enhancer* | 3 - 6g | Temp: Slightly Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Spleen, Stomach, Kidneys | Powerfully descends Qi and calms wheezing and breathlessness. Directs rebellious Qi downward and helps Kidney Qi grasp the Qi sent down by the Lungs, addressing the ascending, rebellious nature of the pathology. |
| **Bing Lang** | Areca seed (Betel nut) | *Enhancer* | 6 - 10g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Stomach, Large Intestine | Strongly promotes the downward movement of Qi, breaks through stagnation and accumulation in the middle burner, and eliminates the sensation of fullness and distension below the heart. |
| **Ren Shen** | Ginseng root | *Balancer* | 6 - 10g | Temp: Slightly Warm<br>Taste: Sweet (&#x7518; g&#x101;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Spleen, Lungs, Heart, Kidneys | Strongly tonifies the original Qi and supports the Spleen and Stomach. Prevents the other three Qi-moving herbs from depleting righteous Qi, ensuring that stagnation is resolved without damaging the body's foundation. This is the key strategic element: descending within ascending, draining within tonifying. |

---

## Scientific Research

1. [Systematic Review and Meta-analysis of Si-Mo-Tang Oral Liquid for Functional Dyspepsia (2017)](https://pubmed.ncbi.nlm.nih.gov/28199409/) (*Lyu Y, et al. PLoS ONE. 2017;12(2):e0171878.*)
...
- **Best Time to Take**: 30 minutes before meals on an empty stomach, 2-3 times daily. The classical method specifies drinking the preparation warm.
- **Typical Duration**: Acute use: 3-7 days. This is a Qi-moving formula not intended for long-term administration. Symptoms should be reassessed if no improvement occurs within 3 days.
- **Dietary Advice**: While taking this formula, avoid cold, raw, and greasy foods, which can impede Qi movement and worsen stagnation. Limit heavy, rich, and fatty meals that burden the Stomach and Spleen. Alcohol should also be avoided. Favor warm, lightly cooked, easily digestible foods such as congee, steamed vegetables, and simple soups. Mildly aromatic foods like small amounts of tangerine peel tea or ginger can complement the formula's Qi-moving action. Because the formula addresses emotional Qi stagnation, maintaining regular mealtimes and eating in a calm, unhurried environment is also beneficial.

---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/si-mo-tang](https://www.meandqi.com/knowledge-base/formulas/si-mo-tang)*
