...
**English Name**: Astragalus and Aconite Decoction  
**Category**: Warming and transforming water-dampness formulas, Interior-warming formulas  
**Dynasty/Source**: Yi Xue Xin Wu (医学心悟)  
...
## Key Metadata
- **TCM Actions**: Warms Yang, Promotes urination, Reduces edema, Tonifies Qi
- **Therapeutic Focus**: Water retention, Edema support, Kidney health, Yang deficiency
- **Target Organs**: Spleen, Kidneys, Lungs
- **Patterns Addressed**: 
- **Conditions Treated**: Edema, Heart Failure, Chronic Kidney Disease
- **Other Names**: 
...
- **Best Time to Take**: Take 30 minutes after meals to reduce potential stomach irritation.
- **Typical Duration**: Typically used for 1–2 weeks; prolonged use requires practitioner reassessment due to Fu Zi's toxicity.
- **Dietary Advice**: Avoid cold and raw foods (e.g., salads, iced drinks, raw fruits) which can further deplete Yang. Favor warm, cooked foods and soups to support the formula's warming and tonifying action.

---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/huang-qi-fu-zi-tang](https://www.meandqi.com/knowledge-base/formulas/huang-qi-fu-zi-tang)*
