# Hua Chong Wan (化虫丸)
**English Name**: Anthelmintic Pill  
...
## Key Metadata
- **TCM Actions**: Expels Parasites, Dries Dampness, Resolves Toxicity
- **Therapeutic Focus**: Digestive Health, Parasite Management, Children's Health
- **Target Organs**: Spleen, Stomach, Large Intestine, Small Intestine
- **Patterns Addressed**: 
- **Conditions Treated**: Ascariasis, Malnutrition, Enterobiasis, Tapeworm Infection, Hookworm Disease, Fasciolopsiasis, Trichomoniasis
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **He Shi** | Carpesium fruit | *King* | 30g (in pill form) | Temp: Neutral<br>Taste: Bitter (&#x82E6; k&#x1D4;), Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Spleen, Stomach | The principal parasite-killing herb in the formula. He Shi is bitter, acrid, and slightly toxic, entering the Spleen and Stomach channels. It is effective against a wide range of intestinal parasites including roundworms, pinworms, hookworms, and tapeworms, making it the broadest-spectrum antiparasitic agent in the formula. |
| **Ku Lian Pi** | Chinaberry bark | *Deputy* | 30g (in pill form) | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Liver, Spleen, Stomach | Strongly kills roundworms and pinworms while also helping to relieve the abdominal pain caused by parasites. Its bitter and cold nature complements He Shi's action and specifically targets roundworms with particular potency. |
| **Bing Lang** | Areca seed (Betel nut) | *Deputy* | 30g (in pill form) | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Stomach, Large Intestine | Kills tapeworms, fasciolopsis, and other parasites, while also promoting Qi movement and providing a mild laxative effect that helps physically expel the paralyzed or dead worm bodies from the intestines. |
| **Qing Fen** | Calomel | *Assistant* | 30g (in pill form) | Temp: Cold<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Liver, Kidneys, Large Intestine | A mineral substance with strong parasite-killing and Dampness-drying properties. It reinforces the antiparasitic action of the other herbs from a different angle (mineral rather than botanical). Note: this ingredient is toxic and is the reason the formula must not be used long-term or in excessive doses. |
| **Ku Fan (&#x67AF;&#x77FE;, Calcined Alum)** |  | *Assistant* | 8g (in pill form) | Temp: <br>Taste: <br>Affinity:  | Dries Dampness and kills parasites. As a mineral substance it complements Qian Fen in eliminating the Damp environment that harbors parasites. The calcined (dried) form of alum is used because its Dampness-drying action is stronger than raw alum. |
