# Yi Gan Tang (抑肝汤)
**English Name**: Liver-Suppressing Decoction  
**Category**: Internal Wind-extinguishing formulas, Spirit-calming formulas  
**Dynasty/Source**: Bǎo Yīng Cuō Yào (保婴撮要, Gathered Essentials for Protecting Infants) by Xuē Kǎi (薛铠) and Xuē Jǐ (薛己)  
...
## Key Metadata
- **TCM Actions**: Calms the Liver and Extinguishes Wind, Clears Liver Heat, Strengthens the Spleen, Nourishes Blood and Softens the Liver, Relaxes Spasms and Relieves Urgency
...
- **Patterns Addressed**: 
- **Conditions Treated**: Dementia, Insomnia, Anxiety, Seizures, Tic Disorder, Neurasthenia, Teeth Grinding, Menopausal Symptoms, Schizophrenia, Borderline Personality Disorder, Tardive Dyskinesia, Essential Tremor, Night Terrors
- **Other Names**: Yi Gan San (抑肝散, Liver-Suppressing Powder)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Gou Teng** | Gambir vine stems and hooks | *King* | 6 - 12g | Temp: Cool<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Liver, Pericardium | Clears Liver Heat, calms Liver Wind, and stops spasms and convulsions. As the principal herb, it directly addresses the core pathomechanism of Liver Wind stirring internally due to Liver deficiency-Heat, providing the formula's primary sedative and antispasmodic action. |
| **Chai Hu** | Bupleurum root | *Deputy* | 3 - 6g | Temp: Slightly Cool<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Liver, Gallbladder, Lungs | Courses the Liver and resolves constraint, allowing Liver Qi to flow freely. It complements Gou Teng by addressing the Qi stagnation dimension of Liver dysfunction while also providing a mild Heat-clearing action through its ascending and dispersing nature. |
| **Dang Gui** | Chinese Angelica root | *Deputy* | 6 - 9g | Temp: Warm<br>Taste: Sweet (&#x7518; g&#x101;n), Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Liver, Heart, Spleen | Nourishes and harmonizes the Blood to soften and emolliate the Liver. When Liver Qi is excessive, Liver Blood becomes depleted. Dang Gui replenishes this deficiency, addressing the root cause that allows Wind to stir. |
| **Chuan Xiong** | Sichuan lovage rhizome | *Assistant* | 3 - 6g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Liver, Gallbladder, Pericardium | Moves Blood and activates Qi within the Blood level. It assists Dang Gui in nourishing and regulating Liver Blood, while its upward-moving and dispersing nature helps relieve headache and dizziness associated with Liver Wind. |
| **Bai Zhu** | White Atractylodes rhizome | *Assistant* | 6 - 9g | Temp: Warm<br>Taste: Bitter (&#x82E6; k&#x1D4;), Sweet (&#x7518; g&#x101;n)<br>Affinity: Spleen, Stomach | Strengthens the Spleen and dries Dampness, protecting the Spleen from being overwhelmed by the overactive Liver (Wood overacting on Earth). This prevents digestive symptoms such as vomiting, bloating, and poor appetite. |
| **Fu Ling** | Poria | *Assistant* | 6 - 9g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n), Bland (&#x6DE1; d&#xE0;n)<br>Affinity: Heart, Lungs, Spleen, Kidneys | Fortifies the Spleen, leaches Dampness, and calms the spirit. Working alongside Bai Zhu to protect the Spleen, Fu Ling also contributes a gentle spirit-quieting effect that supports the formula's overall calming action. |
| **Gan Cao** | Licorice root | *Envoy* | 3 - 6g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Spleen, Stomach | Harmonizes all herbs in the formula, supplements the Spleen, and relaxes tension and spasms. Its sweet flavour moderates the Liver and assists Gou Teng in relieving convulsions and muscular twitching. |

---

## Scientific Research

1. [Systematic review and meta-analysis of RCTs: Yokukansan for behavioral and psychological symptoms of dementia (2013)](https://pubmed.ncbi.nlm.nih.gov/23359469/) (*Matsuda Y, Kishi T, Shibayama H, Iwata N. Human Psychopharmacology: Clinical and Experimental, 2013, 28(1), 80-86.*)
...
2. Updated meta-analysis of RCTs: Yokukansan for BPSD (2016) (*Matsunaga S, Kishi T, Iwata N. Journal of Alzheimer's Disease, 2016, 54(2), 635-643.*)
...
3. Review: Cellular pharmacological effects of Yokukansan on brain cells (2017) (*Mizoguchi K, Ikarashi Y. Frontiers in Pharmacology, 2017, 8, 655.*)
...
4. Preclinical study: Neuroprotective effects of Yokukansan on glutamate-mediated excitotoxicity (2009) (*Kawakami Z, Kanno H, Ueki T, Terawaki K, Tabuchi M, Ikarashi Y, Kase Y. Neuroscience, 2009, 159(4), 1397-1407.*)
...
- **Best Time to Take**: After meals, two to three times daily. The classical text specifies post-meal administration (饭后服). Taking it after food reduces potential digestive sensitivity from Chai Hu and protects the Spleen.
- **Typical Duration**: Acute conditions (childhood convulsions, acute agitation): 3-7 days. Chronic neurological or psychiatric conditions (BPSD, anxiety, insomnia): 4-12 weeks with regular reassessment.
- **Dietary Advice**: Avoid excessively spicy, greasy, and fried foods, which generate Heat and aggravate Liver Fire. Alcohol should be strictly avoided as it produces Damp-Heat and further agitates the Liver. Caffeine and other stimulants may counteract the formula's calming properties and should be minimized.
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/yi-gan-tang](https://www.meandqi.com/knowledge-base/formulas/yi-gan-tang)*
