...
**English Name**: White Tiger Plus Cinnamon Twig Decoction  
**Category**: Heat-clearing formulas, Qi-level Heat-clearing formulas  
**Dynasty/Source**: Jin Gui Yao Lue (金匮要略, Essential Prescriptions of the Golden Cabinet) by Zhang Zhongjing, Chapter on Malaria (疟病脉证并治)  
...
## Key Metadata
- **TCM Actions**: Clears Heat from the Qi level, Generates fluids, Unblocks the channels and collaterals, Relieves joint pain, Harmonizes the Nutritive and Defensive levels
- **Therapeutic Focus**: Joint inflammation, Bone and joint health, Fever management, Gout support
- **Target Organs**: Lungs, Stomach
- **Patterns Addressed**: 
- **Conditions Treated**: Acute Gouty Arthritis, Rheumatoid Arthritis, Rheumatic Fever, Malaria, Ankylosing Spondylitis, Atopic Dermatitis, Systemic Lupus Erythematosus, Postpartum Fever
- **Other Names**: Gui Zhi Bai Hu Tang (桂枝白虎汤), Zhi Mu Tang (知母汤, Anemarrhena Decoction)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Shi Gao** | Gypsum | *King* | 30 - 50g | Temp: Cold<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Sweet (&#x7518; g&#x101;n)<br>Affinity: Lungs, Stomach | The chief Heat-clearing herb and namesake of the Bai Hu (White Tiger) formula family. Strongly clears interior Heat from the Yangming (Stomach and Lung) level, reduces fever, and relieves restlessness. Its cold, pungent-sweet nature powerfully drains blazing Qi-level Heat without drying out body fluids. |
| **Zhi Mu** | Anemarrhena rhizome | *Deputy* | 9 - 18g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;), Sweet (&#x7518; g&#x101;n)<br>Affinity: Lungs, Stomach, Kidneys | Reinforces Shi Gao in clearing Heat from the Lung and Stomach while adding a crucial moistening quality. Where Shi Gao clears Heat rapidly, Zhi Mu's action is slower but more sustained and includes nourishing Yin fluids that have been damaged by the intense interior Heat. |
| **Gui Zhi** | Cinnamon twig | *Assistant* | 5 - 9g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Urinary Bladder | The key addition that distinguishes this formula from the base Bai Hu Tang. Warm and pungent, it unblocks the channels and collaterals to relieve joint pain, harmonizes the Nutritive (Ying) and Defensive (Wei) levels, and guides the formula's cooling action outward to the body surface and into the joints. Its warmth also prevents the cold herbs from congealing the channels. |
| **Jing Mi** | Non-glutinous rice | *Assistant* | 6 - 15g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Spleen, Stomach, Lungs | Sweet and nourishing, it protects the Stomach from the strongly cold nature of Shi Gao and Zhi Mu. Generates fluids to replenish those lost to Heat, and anchors the Middle Qi so that the powerful cold herbs do not injure the Spleen and Stomach. |
| **Zhi Gan Cao** |  | *Envoy* | 3 - 6g | Temp: <br>Taste: <br>Affinity:  | Harmonizes all the herbs in the formula. Works with Geng Mi to protect the Stomach and generate fluids. Its sweetness moderates the cold properties of the main herbs and balances the pungent warmth of Gui Zhi. |
...
- **Best Time to Take**: Warm, divided into two doses per day, taken between meals or on a mild stomach; the classical text notes that mild sweating after taking the formula indicates the therapeutic effect is achieved
- **Typical Duration**: Acute use: 1–7 days, discontinued as soon as fever and joint pain resolve
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/bai-hu-jia-gui-zhi-tang](https://www.meandqi.com/knowledge-base/formulas/bai-hu-jia-gui-zhi-tang)*
