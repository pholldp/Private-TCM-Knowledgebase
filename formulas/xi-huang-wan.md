# Xi Huang Wan (犀黄丸)
**English Name**: Rhinoceros Bezoar Pill  
**Category**: Heat-clearing and toxin-resolving formulas, Abscess-treating formulas  
**Dynasty/Source**: Wai Ke Zheng Zhi Quan Sheng Ji (外科证治全生集) by Wang Weide (王维德)  
...
## Key Metadata
- **TCM Actions**: Clears Heat and resolves toxins, Dissolves Phlegm and dissipates nodules, Invigorates Blood and reduces swelling, Dispels Blood stasis and stops pain
- **Therapeutic Focus**: Cancer support, Breast health, Lymph node health, Abscess and infection support
- **Target Organs**: Heart, Liver, Spleen, Stomach
- **Patterns Addressed**: 
- **Conditions Treated**: Breast Cancer, Breast Lumps, Swollen Lymph Nodes, Abscess, Non-Hodgkin Lymphoma, Liver Cancer, Lung Cancer, Gastric Cancer, Colorectal Cancer, Osteomyelitis, Appendicitis, Acne
- **Other Names**: Xi Huang Wan (西黄丸)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Niu Huang** | Cattle gallstone | *King* | 0.9g | Temp: Cool<br>Taste: Bitter (&#x82E6; k&#x1D4;), Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Liver | Clears Heat and resolves toxins, dissolves Phlegm and dissipates nodules. As the principal medicinal, it directly targets the toxic Heat and Phlegm congestion that form the root of abscesses, breast lumps, and scrofula. |
| **She Xiang** | Musk | *Deputy* | 4.5g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Aromatic (&#x82B3;&#x9999; f&#x101;ng xi&#x101;ng)<br>Affinity: Heart, Liver, Spleen | Opens the channels, moves Qi stagnation, disperses Blood stasis, and resolves swelling of abscesses and toxic sores. Its powerfully aromatic and penetrating nature drives the formula's actions deep into the channels and collaterals. |
| **Ru Xiang** | Frankincense resin | *Assistant* | 30g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Heart, Liver, Spleen | Invigorates Blood, moves Qi, reduces swelling, and alleviates pain. Works in concert with Mo Yao to break up Blood stasis in the channels and relieve the pain caused by toxic sores and nodules. Must be processed to remove oil (去油) to reduce gastric irritation. |
| **Mo Yao** | Myrrh resin | *Assistant* | 30g | Temp: Neutral<br>Taste: Bitter (&#x82E6; k&#x1D4;), Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Heart, Liver, Spleen | Invigorates Blood, dispels stasis, reduces swelling, and stops pain. Pairs with Ru Xiang to enhance the Blood-moving and pain-relieving effects. Must be processed to remove oil (去油) to reduce gastric irritation. |

---

## Scientific Research

1. [Preclinical study: XHW inhibited Lewis lung carcinoma equivalent to cisplatin in a syngeneic mouse model (2021)](https://pubmed.ncbi.nlm.nih.gov/34182475/) (*Zhang Z, Wang J, Duan H, Liu D, Zhou X, Lin X, Pang H, Sun M, Zhou T, Hoffman RM, Hu K. Anticancer Research, 2021, 41(7): 3269-3281.*)
...
2. Meta-analysis: Xihuang Pill combined with chemotherapy for breast cancer treatment (2019) (*Mao D, Feng L, Huang S, Zhang S, Peng W, Zhang S. Evidence-Based Complementary and Alternative Medicine, 2019, Article ID 3502460.*)
...
3. Meta-analysis: Xihuang Pill/Capsule as adjuvant treatment for breast cancer (26 RCTs, 2,272 patients) (*Referenced in: Molecular Cancer, 2025 (review article on TCM in breast cancer treatment).*)
...
- **Best Time to Take**: Twice daily, preferably 30 minutes to 1 hour after meals to reduce potential stomach irritation from Ru Xiang and Mo Yao.
- **Typical Duration**: Typically taken in courses of 1-3 months for tumor-related conditions, then reassessed by a practitioner. For acute inflammatory conditions (boils, abscesses), shorter courses of 2-4 weeks may suffice.
- **Dietary Advice**: While taking Xi Huang Wan, avoid cold and raw foods, greasy or deep-fried foods, and excessively spicy or irritating foods, as these can impair Spleen and Stomach function and hinder the formula's therapeutic action. Since the formula is cool in nature and targets Heat toxin, consuming additional cooling or Heat-clearing foods such as mung beans, winter melon, or pears in moderation is acceptable. Alcohol should be avoided, as it generates Damp-Heat and may interfere with the formula's detoxifying function. A light, easily digestible diet rich in fresh vegetables and adequate protein is recommended to support the body during treatment.

---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/xi-huang-wan](https://www.meandqi.com/knowledge-base/formulas/xi-huang-wan)*
