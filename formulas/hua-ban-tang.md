# Hua Ban Tang (化斑汤)
**English Name**: Macule-Resolving Decoction  
**Category**: Heat-clearing formulas, Nutritive-cooling and Blood-cooling formulas  
**Dynasty/Source**: Wen Bing Tiao Bian (温病条辨, Systematic Differentiation of Warm Pathogen Diseases) by Wu Jutong (吴鞠通)  
...
## Key Metadata
- **TCM Actions**: Clears Heat from the Qi level, Cools the Blood, Resolves Toxicity, Cools the Blood and Resolves Macules, Nourishes Yin
- **Therapeutic Focus**: Skin Health, Fever Management, Immune Support, Vascular Health
- **Target Organs**: Stomach, Lungs, Heart, Kidneys
- **Patterns Addressed**: 
- **Conditions Treated**: Henoch-Schonlein Purpura, Encephalitis, Pityriasis Rosea, Meningitis, Sepsis, Measles, Scarlet Fever, Hemorrhagic Fevers
- **Other Names**: 
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Shi Gao** | Gypsum | *King* | 30g | Temp: Cold<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Sweet (&#x7518; g&#x101;n)<br>Affinity: Lungs, Stomach | Clears blazing Heat from the Qi level, particularly from the Lung and Stomach. As the principal herb, it addresses the core pathomechanism of intense Yangming-level Heat that has spread to the muscle layer and skin, causing maculae. Its acrid-sweet and very cold nature powerfully drains Fire and generates fluids. |
| **Shui Niu Jiao** | Water buffalo horn | *Deputy* | 30 - 60g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;), Salty (&#x54B8; xi&#xE1;n)<br>Affinity: Heart, Liver, Stomach | Enters the Blood level to cool the Blood, clear Heart Fire, resolve toxins, and push maculae outward. The original formula used rhinoceros horn (Xi Jiao), now replaced by water buffalo horn due to wildlife protection laws. Its salty-cold nature directly enters the Blood to address the Blood-level Heat component of the pathomechanism. |
| **Xuan Shen** | Figwort root | *Deputy* | 9 - 12g | Temp: Cold<br>Taste: Sweet (&#x7518; g&#x101;n), Bitter (&#x82E6; k&#x1D4;), Salty (&#x54B8; xi&#xE1;n)<br>Affinity: Lungs, Stomach, Kidneys | Cools the Blood, resolves toxic Heat, and nourishes Yin. It draws upon Kidney Yin to ascend and connect with Lung fluids, preventing the source of Yin from being suddenly exhausted by the intense Heat. This creates a circuit of Water and Metal working together to counterbalance Fire. |
| **Zhi Mu** | Anemarrhena rhizome | *Assistant* | 12g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;), Sweet (&#x7518; g&#x101;n)<br>Affinity: Lungs, Stomach, Kidneys | Clears Heat from the Lung and Stomach, nourishes Yin and moistens Dryness. Supports Shi Gao in draining Qi-level Heat while protecting the Lung (Metal) from being overwhelmed by the excessive Yangming (Stomach) Heat. |
| **Gan Cao** | Licorice root | *Envoy* | 9 - 10g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Spleen, Stomach | Clears Heat and resolves toxins, supplements the Middle Burner, and harmonizes all the other herbs in the formula. Protects the Stomach from being damaged by the strongly cold properties of the other ingredients. |
| **Jing Mi** | Non-glutinous rice | *Envoy* | 9 - 15g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Spleen, Stomach, Lungs | Protects the Stomach and preserves its fluids. The strongly cold herbs in the formula could damage the Middle Burner, and rice cushions this effect while also helping to generate body fluids. Rice is considered the 'grain of Yangming,' making it the natural protective agent for the Stomach. |

---

## Scientific Research

1. Network pharmacology and experimental study on Hua-ban decoction in acute lung injury (2023) (*Zhou W, Hu Z, Wu X, Zhang S, Jiang Y, Tian L, Huang X, Ma Z, Qiu L, Zheng P, Zhang S, Lu Z. Molecular Immunology, 2023, Volume 156, Pages 85-97.*)
...
- **Best Time to Take**: Three times during the day and once at night, as specified in the original text (日三服，夜一服). Ideally taken between meals for faster absorption during acute febrile illness.
- **Typical Duration**: Acute use only: typically 1–5 days, reassessed daily based on fever, maculae, and mental clarity. Discontinue once acute symptoms resolve.
- **Dietary Advice**: Avoid spicy, greasy, fried, and warming foods (lamb, ginger, chili, garlic, alcohol) that may aggravate internal Heat and counteract the formula's cooling effects. Also avoid raw and cold foods that could impair an already stressed digestive system.
Favor light, easily digestible, cooling foods such as mung bean soup, pear, watermelon, winter melon, lotus root, cucumber, and plain rice congee. Adequate hydration is essential, as this pattern involves significant fluid loss from high fever. Small, frequent meals of bland food are preferable to heavy meals.

---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/hua-ban-tang](https://www.meandqi.com/knowledge-base/formulas/hua-ban-tang)*
