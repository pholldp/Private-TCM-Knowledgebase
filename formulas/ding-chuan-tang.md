...
**Category**: Qi-regulating formulas, Phlegm-resolving formulas  
**Dynasty/Source**: Shè Shēng Zhòng Miào Fāng (摄生众妙方, Multitude of Marvelous Formulas for Sustaining Life) by Zhang Shiche  
...
## Key Metadata
- **TCM Actions**: Restores Lung Diffusing and Descending Functions, Calms Wheezing, Clears Lung Heat, Resolves Phlegm, Releases the Exterior
- **Therapeutic Focus**: Respiratory Health, Asthma and Wheezing Relief, Cough and Phlegm Relief
- **Target Organs**: Lungs, Large Intestine
- **Patterns Addressed**: 
- **Conditions Treated**: Asthma, Chronic Obstructive Pulmonary Disease, Chronic Bronchitis, Bronchiolitis, Hypochondrial Pain That Is Worse On Coughing And Breathing, Wheezing
- **Other Names**: Bai Guo Ding Chuan Tang (白果定喘汤, Ginkgo Arrest Wheezing Decoction)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Bai Guo** | Ginkgo seed | *Main* | 9 - 12g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n), Bitter (&#x82E6; k&#x1D4;), Astringent (&#x6DA9; s&#xE8;)<br>Affinity: Lungs, Kidneys | Constrains Lung Qi to arrest wheezing, transforms phlegm, and prevents Ma Huang from over-dispersing. Its astringent nature balances the dispersing action of Ma Huang, creating a 'one scattering, one collecting' dynamic that powerfully stabilizes the airways. |
| **Ma Huang** | Ephedra stem | *Main* | 6 - 9g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Lungs, Urinary Bladder | Opens and disseminates Lung Qi, releases the exterior to dispel Wind-Cold, and arrests wheezing. As the other King herb, it addresses the external component of the pattern and restores the Lung's descending and dispersing functions. |
| **Zi Su Zi** | Perilla seed | *Enhancer* | 6 - 9g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Lungs, Large Intestine | Directs Lung Qi downward, resolves phlegm, and stops wheezing. Reinforces the descending action needed to counter the upward rebellion of Lung Qi. |
| **Xing Ren** | Bitter apricot kernel | *Enhancer* | 4.5 - 9g | Temp: Slightly Warm<br>Taste: Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Lungs, Large Intestine | Descends Lung Qi and stops coughing. Works with Ma Huang in a classic pairing where Ma Huang opens and Xing Ren descends, restoring normal Lung Qi movement. |
| **Ban Xia** | Pinellia rhizome | *Enhancer* | 9g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Spleen, Stomach, Lungs | Dries Dampness and transforms phlegm, directs rebellious Qi downward, and harmonizes the Stomach. A key herb for resolving the sticky, accumulated phlegm obstructing the airways. |
| **Kuan Dong Hua** | Coltsfoot Flower | *Enhancer* | 9g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Lungs | Moistens the Lungs, descends Qi, and stops coughing. Supports the phlegm-resolving and cough-suppressing actions of the other Deputy herbs. |
| **Sang Bai Pi** | Mulberry root bark | *Balancer* | 6 - 9g | Temp: Cold<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Lungs, Spleen | Drains Lung heat, descends Lung Qi, and promotes urination. Clears the interior heat that has transformed from constrained Qi, and works with Huang Qin to address the phlegm-heat component. |
| **Huang Qin** | Baical skullcap root | *Balancer* | 4.5 - 6g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Lungs, Gallbladder, Spleen, Large Intestine, Small Intestine, Heart, Stomach | Clears heat from the Lungs, dries dampness, and stops coughing. Directly targets the phlegm-heat that produces thick yellow sputum, and prevents the warm, dispersing herbs from generating further heat. |
| **Gan Cao** | Licorice root | *Deliverer* | 3g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Spleen, Stomach | Harmonizes the actions of all the other herbs in the formula, moderates the harshness of the dispersing and descending ingredients, and protects the Stomach. |

---

## Scientific Research

1. [Randomized, double-blind, placebo-controlled clinical trial of DCT for airway hyper-responsiveness in asthmatic children (2006)](https://doi.org/10.1111/j.1399-3038.2006.00406.x) (*Chan CK, Kuo ML, Shen JJ, See LC, Chang HH, Huang JL. Pediatric Allergy and Immunology, 2006, 17(5): 316-322.*)
...
2. [Preclinical study: DCT attenuates airway inflammation and eosinophil infiltration in ovalbumin-sensitized asthmatic mice (2021)](https://doi.org/10.1155/2021/6692772) (*Ma J, Liu MX, Chen LC, Shen JJ, Kuo ML. BioMed Research International, 2021, 2021: 6692772.*)
...
3. [Preclinical study: Effects of DCT on bronchoconstriction and airway leukocyte infiltration in sensitized guinea pigs (2004)](https://pubmed.ncbi.nlm.nih.gov/15106736/) (*Kao ST, Chang CH, Chen YS, Chiang SY, Lin JG. Immunopharmacology and Immunotoxicology, 2004, 26(1): 113-124.*)
...
4. [Network pharmacology study: Molecular docking and network connections of active compounds from DCT (2020)](https://pubmed.ncbi.nlm.nih.gov/32185106/) (*Kelly-Cirino C. PeerJ, 2020, 8: e8685.*)
...
- **Best Time to Take**: As the original text states, 'not restricted by time' (不拘时候). Typically taken warm, sipped slowly (徐徐服), twice daily between meals.
- **Typical Duration**: Acute use: 3-10 days during active wheezing episodes, reassessed as symptoms change.
- **Dietary Advice**: Avoid cold, raw foods and iced drinks, which can constrict the Lungs and worsen Phlegm accumulation. Also avoid greasy, fried, and rich foods, as these generate Dampness and Phlegm. Reduce intake of excessively spicy or hot foods, which may aggravate the internal Heat component. Dairy products and overly sweet foods should be minimized as they tend to promote Phlegm production. Suitable foods include steamed pears with rock sugar (to moisten the Lungs), white radish soup (to transform Phlegm), and light, easily digested warm meals like congee with lily bulb.

---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/ding-chuan-tang](https://www.meandqi.com/knowledge-base/formulas/ding-chuan-tang)*
