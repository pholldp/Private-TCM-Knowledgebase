# Zhi Zi Gan Cao Chi Tang (栀子甘草豉汤)
**English Name**: Gardenia, Licorice, and Prepared Soybean Decoction  
**Category**: Heat-clearing formulas, Organ Heat-clearing formulas  
**Dynasty/Source**: Shang Han Lun (伤寒论, Treatise on Cold Damage), Line 76, by Zhang Zhongjing (张仲景)  
...
## Key Metadata
- **TCM Actions**: Clears Heat and Eliminates Irritability, Disperses Depressed Heat, Tonifies the Middle and Augments Qi
- **Therapeutic Focus**: Sleep Support, Stress and Anxiety, Digestive Health, Post-Illness Recovery
- **Target Organs**: Heart, Lungs, Stomach, Spleen
- **Patterns Addressed**: 
- **Conditions Treated**: Insomnia, Anxiety, Acute Encephalitis, Gastritis, Depression, Neurasthenia, Menopausal Symptoms, Breast Pruritus
- **Other Names**: Zhi Zi Chi Jia Gan Cao Tang (栀子豉加甘草汤)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Zhi Zi** | Gardenia fruit | *King* | 9 - 14g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Heart, Lungs, San Jiao (Triple Burner) | The primary herb that clears Heat from the chest and diaphragm and relieves irritability. Its bitter, cold nature drains depressed Heat downward while its light quality also allows it to vent Heat outward, directly addressing the core pathomechanism of Heat lodged in the upper body. |
| **Dan Dou Chi** | Fermented soybean | *Deputy* | 9 - 12g | Temp: Cool<br>Taste: Bitter (&#x82E6; k&#x1D4;), Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Lungs, Stomach | A light, ascending herb that disperses and vents depressed Heat from the chest and diaphragm. While Zhi Zi clears Heat downward, Dan Dou Chi lifts and disperses it outward, creating a complementary ascending-descending dynamic that thoroughly resolves chest-level Heat stagnation. Also harmonizes the Stomach. |
| **Gan Cao** | Licorice root | *Assistant* | 6 - 9g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Spleen, Stomach | Added specifically for the symptom of shortness of breath (少气), indicating underlying Qi deficiency alongside the Heat pattern. Its sweet, warm nature tonifies the middle Qi and harmonizes the formula, preventing the cold and bitter Zhi Zi from further injuring the already weakened Qi. It gently supports the body's vital Qi without being so strongly tonifying as to worsen the pathological Heat. |
...
- **Best Time to Take**: Between meals, taken warm, divided into two doses per day. Classically: take one dose first, and if vomiting occurs, do not take the second dose.
- **Typical Duration**: Acute use: 3-5 days. This is a short-course formula designed to clear residual Heat after illness. Reassess promptly if symptoms persist.
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/zhi-zi-gan-cao-chi-tang](https://www.meandqi.com/knowledge-base/formulas/zhi-zi-gan-cao-chi-tang)*
