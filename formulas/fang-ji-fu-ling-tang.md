...
**English Name**: Stephania and Poria Decoction  
**Category**: Dampness-draining and urination-promoting formulas  
**Dynasty/Source**: Jin Gui Yao Lue (金匮要略), Chapter 14: Water Qi Disease (水气病脉证并治第十四), by Zhang Zhongjing  
...
## Key Metadata
- **TCM Actions**: Promotes Urination and Reduces Edema, Warms Yang and Transforms Qi, Tonifies Qi, Drains Water from the Skin and Flesh, Unblocks Yang in the Exterior
- **Therapeutic Focus**: Fluid Retention and Edema, Kidney Health, Joint and Muscle Pain Relief, Circulation Support
- **Target Organs**: Spleen, Lungs, Urinary Bladder, Kidneys
- **Patterns Addressed**: 
- **Conditions Treated**: Edema, Chronic Nephritis, Congestive Heart Failure, Nephrotic Syndrome, Rheumatoid Arthritis, Gout, Deep Vein Thrombosis, Cirrhosis
- **Other Names**: 
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Fu Ling** | Poria | *Main* | 18g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n), Bland (&#x6DE1; d&#xE0;n)<br>Affinity: Heart, Lungs, Spleen, Kidneys | At double the dosage of the other herbs, Fu Ling is the chief water-draining herb in this formula. It strengthens the Spleen to restore its fluid-transporting function and promotes urination to drain accumulated water from the skin and tissues. Its gentle, tonifying nature allows it to resolve dampness without injuring healthy fluids. |
| **Fang Ji** | Fourstamen Stephania Root | *Enhancer* | 9g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;), Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Urinary Bladder, Kidneys, Spleen | Bitter, pungent, and slightly cold, Fang Ji is a powerful dampness-draining and edema-reducing herb. It expels water retained in the skin and superficial tissues, working from the surface level. Together with Fu Ling, it addresses water accumulation from both the exterior and interior simultaneously. |
| **Huang Qi** | Astragalus root | *Enhancer* | 9g | Temp: Slightly Warm<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Spleen, Lungs | Sweet and warm, Huang Qi tonifies Qi and strengthens the exterior defensive Qi. It supports the Spleen's ability to manage fluids and assists Fang Ji in resolving superficial water retention. Its Qi-boosting action ensures the body has sufficient functional strength to move and transform accumulated fluids. |
| **Gui Zhi** | Cinnamon twig | *Balancer* | 9g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Urinary Bladder | Gui Zhi warms Yang and promotes the transformation of Qi, which is essential for restoring the Bladder's ability to process and excrete fluids. When combined with Fu Ling, Gui Zhi does not release the exterior through sweating but instead redirects its warming action to assist water metabolism. It also addresses the muscle twitching caused by Yang being obstructed by water stagnation. |
| **Gan Cao** | Licorice root | *Deliverer* | 6g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Spleen, Stomach | Harmonizes the actions of all the other herbs in the formula. It also supports the Spleen and Middle Burner, reinforcing the formula's overall Qi-tonifying strategy. Its moderating effect helps balance the draining nature of the diuretic herbs with the warming nature of Gui Zhi. |
...
- **Best Time to Take**: 30 minutes before meals, divided into two or three doses per day, taken warm.
- **Typical Duration**: Typically prescribed for 2-4 weeks for acute edema, with reassessment; may be continued for 4-8 weeks in chronic cases under practitioner supervision.
- **Dietary Advice**: Avoid cold, raw, and icy foods and drinks, which can impair Spleen Yang and worsen fluid accumulation. Reduce salt intake, as excess sodium promotes water retention and directly opposes the formula's diuretic intent. Limit greasy, fatty, and heavy foods that generate Dampness. Favor warm, lightly cooked, easily digestible foods such as congee, cooked grains, winter squash, small red beans (chi xiao dou), and barley (yi yi ren), which gently support Spleen function and help resolve dampness.

---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/fang-ji-fu-ling-tang](https://www.meandqi.com/knowledge-base/formulas/fang-ji-fu-ling-tang)*
