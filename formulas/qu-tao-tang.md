# Qu Tao Tang (驱绦汤)
**English Name**: Tapeworm-Expelling Decoction  
**Category**: Parasite-expelling formulas  
**Dynasty/Source**: 《方剂学》 (Formula Studies, modern textbook; multiple editions)  
...
## Key Metadata
- **TCM Actions**: Expels intestinal tapeworms, Drains Heat and dries Dampness, Moves Qi and breaks stagnation
- **Therapeutic Focus**: Digestive health, Parasite cleansing, Abdominal bloating relief
- **Target Organs**: Stomach, Large Intestine
- **Patterns Addressed**: 
- **Conditions Treated**: Taeniasis
- **Other Names**: 
...
- **Best Time to Take**: Early morning, on an empty stomach. Follow the two-step method: chew and swallow the pumpkin seeds first, then 1–2 hours later drink the concentrated betel nut decoction.
- **Typical Duration**: Single dose; if the scolex (head) of the tapeworm is not expelled, the dose may be repeated after 15 days.
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/qu-tao-tang](https://www.meandqi.com/knowledge-base/formulas/qu-tao-tang)*
