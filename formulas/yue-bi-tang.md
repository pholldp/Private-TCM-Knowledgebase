# Yue Bi Tang (越婢汤)
**English Name**: Maidservant from Yue Decoction  
**Category**: Exterior-releasing formulas, Dampness-resolving formulas  
...
## Key Metadata
- **TCM Actions**: Disseminates Lung Qi and promotes water movement, Clears interior Heat, Induces sweating to release the Exterior, Reduces edema and resolves swelling
- **Therapeutic Focus**: Edema and water retention, Kidney health, Skin health, Joint health
- **Target Organs**: Lungs, Spleen, Stomach, Urinary Bladder
- **Patterns Addressed**: 
- **Conditions Treated**: Edema, Acute Nephritis, Urticaria, Chronic Nephritis, Nephrotic Syndrome, Asthma, Rheumatoid Arthritis, Allergic Skin Conditions, Bronchitis
- **Other Names**: 
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Ma Huang** | Ephedra stem | *King* | 12 - 18g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Lungs, Urinary Bladder | The principal herb, used in a heavy dose to powerfully open the Lung Qi, promote sweating to expel Wind from the surface, and restore the Lung's water-regulating function. By opening the surface and the waterways, it allows accumulated fluid to be excreted both through sweat and through urination. Its strong ascending and dispersing nature is the driving force behind the formula's ability to move stagnant water. |
| **Shi Gao** | Gypsum | *Deputy* | 24 - 30g | Temp: Cold<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Sweet (&#x7518; g&#x101;n)<br>Affinity: Lungs, Stomach | Used in a dose heavier than Ma Huang (a ratio of roughly 4:3) to clear the Heat trapped in the Lung and Stomach. Its cold, pungent nature both complements the dispersing action of Ma Huang and restrains Ma Huang's warm, drying character, preventing excessive sweating that would damage fluids. Together with Ma Huang, it creates the formula's signature strategy of simultaneously venting the surface and clearing interior Heat. |
| **Sheng Jiang** | Fresh ginger rhizome | *Assistant* | 9g | Temp: Slightly Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Lungs, Spleen, Stomach | Assists Ma Huang in dispersing and opening the surface, enhancing the formula's ability to expel Wind and move water outward. Its warm, pungent quality also harmonizes the Stomach, helping to prevent nausea from the heavy mineral Shi Gao. |
| **Da Zao** | Jujube fruit | *Assistant* | 15 pieces | Temp: Warm<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Spleen, Stomach, Heart | Nourishes the Spleen and Stomach and supports the middle Qi. By strengthening the Spleen's water-transforming function, it helps the body properly process and eliminate fluid accumulation. It also protects the Stomach from the cold nature of Shi Gao and moderates the harsh dispersing action of Ma Huang. |
| **Gan Cao** | Licorice root | *Envoy* | 6g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Spleen, Stomach | Harmonizes all the herbs in the formula, tonifies the middle Qi to support the Spleen in transforming Dampness, and pairs with Da Zao to protect the Stomach. Also moderates the dispersing force of Ma Huang to prevent over-sweating. |

---

## Scientific Research

1. [Preclinical study: Yue-bi-tang attenuates adriamycin-induced nephropathy edema via Cav-1/eNOS pathway (2023)](https://doi.org/10.3389/fphar.2023.1138900) (*Li T, Cheng S, Xu L, Lin P, Shao M. Frontiers in Pharmacology, 2023, 14:1138900.*)
...
2. [Preclinical study: Effects of Yue-Bi-Tang on water metabolism in severe acute pancreatitis rats with acute lung-kidney injury (2020)](https://doi.org/10.3748/wjg.v26.i43.6810) (*Hu J, Zhang YM, Miao YF, Zhu L, Yi XL, Chen H, et al. World Journal of Gastroenterology, 2020, 26(43): 6810-6821.*)
...
3. [Network pharmacology and preclinical study: Exploring the therapeutic mechanism of Yuebi Decoction on nephrotic syndrome (2024)](https://doi.org/10.18632/aging.206116) (*Yao T, Wang Q, Han S, Xu Y, Chen M, Wang Y. Aging, 2024, 16: doi:10.18632/aging.206116.*)
...
- **Best Time to Take**: Warm, divided into 2–3 doses per day, ideally between meals. For acute edema with exterior symptoms, taking a dose before bed may enhance the diaphoretic effect.
- **Typical Duration**: Acute use: 3–7 days. This is a strong dispersing formula for acute conditions and should not be taken long-term without reassessment.
- **Dietary Advice**: While taking this formula, avoid cold and raw foods (such as ice cream, cold salads, and raw fish) as they can impair the Spleen's ability to transform dampness, which the formula is trying to resolve. Also avoid greasy, oily, and heavily fried foods, as these generate more Dampness and burden the Spleen and Stomach.
Salty and heavily seasoned foods should be limited, especially if there is significant edema, since excess salt promotes fluid retention. Light, warm, and easily digestible foods are best, such as plain rice porridge (congee), lightly cooked vegetables, and mild soups.
Avoid alcohol, which generates Dampness and Heat internally and may interfere with the formula's action. The classical tradition also advises caution with wind-provoking foods (such as shellfish and certain fermented foods) when treating Wind-related conditions.

---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/yue-bi-tang](https://www.meandqi.com/knowledge-base/formulas/yue-bi-tang)*
