...
**English Name**: Rhubarb and Eupolyphaga Pill  
**Category**: Blood-invigorating and stasis-resolving formulas  
**Dynasty/Source**: Jin Gui Yao Lue (金匮要略, Essentials from the Golden Cabinet) by Zhang Zhongjing, Chapter 6: Blood Impediment and Deficiency Taxation Disease Pulse Patterns and Treatment (血痹虚劳病脉证并治)  
...
## Key Metadata
- **TCM Actions**: Transforms and Expels Blood Stasis, Invigorates Blood and Unblocks the Channels and Collaterals, Clears Heat from Blood Stasis, Nourishes Yin and Blood, Removes Stasis and Generates New Blood
- **Therapeutic Focus**: Liver Health, Women's Reproductive Health, Circulation Support, Skin Health
- **Target Organs**: Liver, Spleen, Large Intestine, Uterus
- **Patterns Addressed**: 
- **Conditions Treated**: Cirrhosis, Uterine Fibroids, Amenorrhea, Hepatic Fibrosis, Chronic Hepatitis, Ovarian Cysts, Endometriosis, Deep Vein Thrombosis, Psoriasis, Breast Lumps, Atherosclerosis
- **Other Names**: Da Huang Zhe Chong Wan (大黄䗪虫丸, Rhubarb and Ground Beetle Pill)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Da Huang** | Rhubarb root and rhizome | *King* | 6 - 9g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Spleen, Stomach, Large Intestine, Liver, Pericardium | Purges accumulated stagnant Blood, cools Blood-Heat, and drives out old dead Blood through the bowels. Its ability to 'push out the old and bring in the new' (推陈致新) makes it the primary force for breaking through dry Blood obstruction. |
| **Tu Bie Chong** | Ground beetle | *King* | 3 - 6g | Temp: Cold<br>Taste: Salty (&#x54B8; xi&#xE1;n)<br>Affinity: Liver | Breaks up fixed Blood stasis masses and unblocks the channels. Its salty, cold nature enters the Blood level to dissolve hardened, dried-out Blood that has accumulated over time. Paired with Da Huang, the two kings work together to drive out dry Blood from the entire body. |
| **Tao Ren** | Peach kernel | *Deputy* | 6 - 9g | Temp: Neutral<br>Taste: Bitter (&#x82E6; k&#x1D4;), Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Liver, Large Intestine | Invigorates Blood, breaks up stasis, and moistens the intestines. Supports the kings in moving stagnant Blood while adding a moistening quality that helps counter the dryness of the dry Blood pattern. |
| **Gan Qi** | Dried Lacquer | *Deputy* | 1 - 3g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Liver, Spleen | Powerfully breaks Blood stasis and disperses accumulated masses. Its warm, acrid nature penetrates deeply to dissolve stubborn, fixed Blood accumulations that lighter herbs cannot reach. |
| **Qi Cao** | Scarab Beetle Larva | *Deputy* | 3 - 6g | Temp: Slightly Warm<br>Taste: Salty (&#x54B8; xi&#xE1;n)<br>Affinity: Liver | An insect substance that breaks up Blood stasis and unblocks the channels. Works alongside the other insect ingredients to dissolve deep, stubborn masses and promote circulation in the collaterals. |
| **Shui Zhi** | Leech | *Deputy* | 3 - 6g | Temp: Neutral<br>Taste: Salty (&#x54B8; xi&#xE1;n), Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Liver, Urinary Bladder | A potent Blood-breaking insect medicinal. Enters the Blood level to dissolve fixed stasis and break apart dried, clotted Blood. Particularly effective for opening obstructed collateral vessels. |
| **Meng Chong** | Gadfly | *Deputy* | 3 - 6g | Temp: Cool<br>Taste: Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Liver | Breaks up Blood stasis and disperses accumulations. Another powerful insect ingredient that reinforces the Blood-breaking capacity of the formula, targeting fixed masses in the abdomen. |
| **Huang Qin** | Baical skullcap root | *Assistant* | 6 - 9g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Lungs, Gallbladder, Spleen, Large Intestine, Small Intestine, Heart, Stomach | Clears Heat, particularly the stagnant Heat that builds up from chronic Blood stasis. Paired with Da Huang it clears Heat from upper and lower parts of the body. With Xing Ren it clears constrained Heat from the Lungs. |
| **Xing Ren** | Bitter apricot kernel | *Assistant* | 6 - 9g | Temp: Slightly Warm<br>Taste: Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Lungs, Large Intestine | Descends Lung Qi and moistens the intestines. By directing Qi downward, it supports the elimination of stagnant Blood. Paired with Tao Ren, the two seeds moisten dryness and facilitate bowel movement to help expel stasis. |
| **Sheng Di Huang (Raw Rehmannia root)** |  | *Assistant* | 9 - 15g | Temp: <br>Taste: <br>Affinity:  | Nourishes Yin and Blood, cools the Blood, and moistens dryness. The largest herb by classical dosage in this formula, it provides essential nourishment to prevent the harsh Blood-breaking ingredients from depleting healthy Blood and Yin. It moistens the dry Blood condition from the inside. |
| **Bai Shao** | White peony root | *Assistant* | 9 - 12g | Temp: Slightly Cool<br>Taste: Bitter (&#x82E6; k&#x1D4;), Sour (&#x9178; su&#x101;n)<br>Affinity: Liver, Spleen | Nourishes Blood, softens the Liver, and relieves abdominal cramping. Together with Sheng Di Huang and Gan Cao it provides a tonifying, protective layer that prevents the attacking herbs from injuring healthy Qi and Blood. |
| **Gan Cao** | Licorice root | *Envoy* | 3 - 6g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Spleen, Stomach | Harmonizes the Middle Burner, protects the Stomach, and moderates the harsh properties of the powerful Blood-breaking herbs. As the envoy, it coordinates the actions of all twelve ingredients and prevents them from overly damaging healthy Qi. |

---

## Scientific Research

1. [Meta-analysis: Dahuang Zhechong formula for liver fibrosis in chronic hepatitis B (2015)](https://pubmed.ncbi.nlm.nih.gov/25637160/) (*Wei F, Lang Y, Gong D, Fan Y. Complement Ther Med. 2015 Feb;23(1):129-138.*)
...
2. Systematic review and meta-analysis: Dahuang Zhechong pill for hepatic fibrosis and cirrhosis (2022) (*Ye Z, Huang Q, She Y, et al. Front Med (Lausanne). 2022 Oct 14;9:920062.*)
...
3. [Preclinical study: Dahuang Zhechong Pill suppresses colorectal cancer liver metastasis (2019)](https://pubmed.ncbi.nlm.nih.gov/30986521/) (*Journal of Ethnopharmacology. 2019. (Authors: multiple, Nanjing University of Chinese Medicine)*)
...
4. Preclinical study: Liver protection and toxicity evaluation of Da-Huang-Zhe-Chong pill in rats (2012) (*Xing XY, Zhao YL, Jia L, et al. Pharm Biol. 2012;50(3):344-350.*)
