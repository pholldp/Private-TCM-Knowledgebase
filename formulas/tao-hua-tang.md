# Tao Hua Tang (桃花汤)
**English Name**: Peach Blossom Decoction  
...
## Key Metadata
- **TCM Actions**: Warms the Middle Burner, Astringes the Intestines and Stops Diarrhea, Secures Essence and Stops Leakage, Stops Dysentery, Stops Bleeding
- **Therapeutic Focus**: Digestive Health, Chronic Diarrhea, Gut Health
- **Target Organs**: Spleen, Kidneys, Large Intestine, Stomach
- **Patterns Addressed**: 
- **Conditions Treated**: Ulcerative Colitis, Chronic Diarrhea, Chronic Dysentery, Gastrointestinal Bleeding, Abnormal Uterine Bleeding, Leukorrhea
- **Other Names**: 
...
- **Best Time to Take**: Taken warm, three times daily between meals. Traditionally served at a warm temperature (温服) to support the warming therapeutic intent.
- **Typical Duration**: Acute use: 1-7 days. The classical text explicitly instructs 'if cured after one dose, do not take the remainder,' emphasizing short-term use only until diarrhea stops.
- **Dietary Advice**: While taking this formula, favor warm, easily digestible, bland foods such as plain rice porridge (congee), cooked root vegetables, and mild soups. The formula already contains rice (Jing Mi), reflecting the classical emphasis on protecting the stomach during treatment.
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/tao-hua-tang](https://www.meandqi.com/knowledge-base/formulas/tao-hua-tang)*
