...
**English Name**: Licorice and Dried Ginger Decoction  
**Category**: Interior-warming formulas, Yang-rescuing formulas  
**Dynasty/Source**: Shang Han Lun (傷寒論) by Zhang Zhongjing; also recorded in Jin Gui Yao Lue (金匱要略)  
...
## Key Metadata
- **TCM Actions**: Warms the Middle Burner and Restores Yang, Warms the Lungs and Transforms Phlegm-Fluids, Tonifies Spleen Qi, Disperses Cold
- **Therapeutic Focus**: Respiratory Health, Digestive Health, Bladder Health, Cold Constitution Support
- **Target Organs**: Spleen, Lungs, Stomach
- **Patterns Addressed**: 
- **Conditions Treated**: Chronic Bronchitis, Enuresis, Chronic Gastritis, Chronic Obstructive Pulmonary Disease, Bronchial Asthma, Peptic Ulcer, Chronic Diarrhea, Allergic Sinusitis, Vertigo, Abnormal Uterine Bleeding, Epistaxis
- **Other Names**: Gan Jiang Gan Cao Tang (干姜甘草汤), Fu Yin Tang (复阴汤)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Gan Jiang** | Dried ginger rhizome | *King* | 6 - 12g | Temp: Hot<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Heart, Spleen, Lungs, Stomach | Warms the Middle Burner and disperses interior Cold. Its hot, acrid nature restores Yang in the Spleen and Lungs, directly addressing the core pathomechanism of Cold congesting the middle and upper body. It warms the Lungs to resolve thin watery phlegm (cold-type fluid retention) and warms the Spleen to restore its transforming and transporting functions. |
| **Gan Cao** | Licorice root | *Deputy* | 12 - 24g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Spleen, Stomach | Tonifies Spleen Qi and supplements the Middle Burner, reinforcing the warming action of Gan Jiang from the Qi-nourishing side. Its sweet, warm nature moderates the harsh drying quality of Gan Jiang, allowing warmth to be sustained without damaging fluids. In combination with Gan Jiang, the sweet-acrid pairing (辛甘化阳) generates Yang gently and effectively. Used at double the dosage of Gan Jiang to anchor the formula in tonification. |
...
- **Best Time to Take**: Divide into two warm doses per day, taken between meals (on a relatively empty stomach) to maximize absorption of the warming properties. For bleeding conditions, classical sources advise cooling the decoction before drinking.
- **Typical Duration**: Acute use: 1–5 days; chronic cold patterns such as cold-type Lung atrophy may be used for 1–2 weeks, reassessed by a practitioner.
- **Dietary Advice**: Avoid cold, raw, and chilled foods and beverages while taking this formula, as they directly oppose its warming purpose and can weaken the Spleen Yang the formula is trying to restore. This includes raw salads, cold fruits, iced drinks, ice cream, and excessive dairy.
Favor warm, cooked, easily digestible foods such as congee (rice porridge), soups, cooked root vegetables, and warm grains. Small amounts of ginger, cinnamon, or fennel in cooking can support the formula's warming action. Avoid greasy, heavy, or overly rich foods that burden the Spleen's digestive function.

---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/gan-cao-gan-jiang-tang](https://www.meandqi.com/knowledge-base/formulas/gan-cao-gan-jiang-tang)*
