...
**English Name**: Scutellaria Decoction Plus Pinellia and Fresh Ginger  
**Category**: Heat-clearing formulas, Harmonizing formulas  
**Dynasty/Source**: Shang Han Lun (伤寒论, Treatise on Cold Damage) by Zhang Zhongjing, Clause 172; also recorded in Jin Gui Yao Lue (金匮要略, Essential Prescriptions of the Golden Cabinet)  
...
## Key Metadata
- **TCM Actions**: Clears Heat and Stops Diarrhea, Harmonizes the Stomach and Stops Vomiting, Descends Qi, Relieves Abdominal Pain
- **Therapeutic Focus**: Digestive Health, Nausea and Vomiting Relief, Diarrhea Relief
- **Target Organs**: Stomach, Large Intestine, Spleen, Gallbladder
- **Patterns Addressed**: 
- **Conditions Treated**: Acute Gastroenteritis, Ulcerative Colitis, Nausea Or Vomiting, Diarrhea, Dysentery, Irritable Bowel Syndrome, Morning Sickness
- **Other Names**: 
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Huang Qin** | Baical skullcap root | *Main* | 9 - 15g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;)<br>Affinity: Lungs, Gallbladder, Spleen, Large Intestine, Small Intestine, Heart, Stomach | The chief herb of the formula, Huang Qin clears Heat and dries Dampness, particularly in the Shaoyang and Yangming channels. It directly addresses the core pathomechanism of Heat forcing downward into the intestines, causing diarrhea with foul-smelling stools and a burning sensation at the anus. |
| **Bai Shao** | White peony root | *Enhancer* | 6 - 10g | Temp: Slightly Cool<br>Taste: Bitter (&#x82E6; k&#x1D4;), Sour (&#x9178; su&#x101;n)<br>Affinity: Liver, Spleen | Nourishes the Blood and softens the Liver while relieving abdominal cramping and pain. Paired with Huang Qin, it prevents the bitter-cold nature of Huang Qin from damaging Yin fluids. Its sour-astringent quality also helps contain the diarrhea. |
| **Ban Xia** | Pinellia rhizome | *Balancer* | 9 - 12g | Temp: Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Spleen, Stomach, Lungs | The key addition that distinguishes this formula from Huang Qin Tang. Ban Xia descends rebellious Stomach Qi and stops vomiting, transforms Phlegm-Dampness, and harmonizes the middle. It directly addresses the nausea and vomiting that accompany the diarrhea. |
| **Sheng Jiang** | Fresh ginger rhizome | *Balancer* | 5 - 9g | Temp: Slightly Warm<br>Taste: Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Lungs, Spleen, Stomach | Works synergistically with Ban Xia to descend rebellious Qi and stop vomiting. Its warm nature moderates the cold properties of Huang Qin, harmonizes the Stomach, and helps reduce the toxicity of Ban Xia. |
| **Gan Cao** | Licorice root | *Deliverer* | 6g | Temp: Neutral<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Heart, Lungs, Spleen, Stomach | Tonifies the Spleen Qi and protects the middle burner from the bitter-cold nature of Huang Qin. Paired with Shao Yao, it helps relieve abdominal cramping. As the envoy, it harmonizes all herbs in the formula and moderates their potentially harsh properties. |
| **Da Zao** | Jujube fruit | *Deliverer* | 4 - 12 pieces | Temp: Warm<br>Taste: Sweet (&#x7518; g&#x101;n)<br>Affinity: Spleen, Stomach, Heart | Nourishes the Spleen and Stomach, generates fluids, and moderates the harsh properties of the other herbs. Together with Zhi Gan Cao, it protects the digestive system from the bitter-cold action of Huang Qin. |
...
- **Best Time to Take**: Warm, divided into three doses daily: morning, afternoon, and evening (日再夜一服, literally twice during the day and once at night). Take between meals on a relatively empty stomach for best absorption.
- **Typical Duration**: Acute use: 1–5 days, typically resolving within 1–3 doses for uncomplicated cases. Discontinue when vomiting and diarrhea cease.
...
---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/huang-qin-jia-ban-xia-sheng-jiang-tang](https://www.meandqi.com/knowledge-base/formulas/huang-qin-jia-ban-xia-sheng-jiang-tang)*
