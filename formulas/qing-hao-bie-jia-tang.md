...
**English Name**: Artemisia and Turtle Shell Decoction  
**Category**: Heat-clearing formulas, Deficiency Heat-clearing formulas  
**Dynasty/Source**: Wen Bing Tiao Bian (温病条辨), Volume 3, Lower Burner Chapter, by Wu Jutong (吴鞠通)  
...
## Key Metadata
- **TCM Actions**: Nourishes Yin, Clears Deficiency Heat, Vents Pathogenic Heat Outward, Cools the Blood
- **Therapeutic Focus**: Low-Grade Fever Management, Post-Illness Recovery, Immune Support
- **Target Organs**: Liver, Kidneys
- **Patterns Addressed**: 
- **Conditions Treated**: Low Grade Fever In The Afternoon, Tuberculosis, Fever Of Unknown Origin, Chronic Pyelonephritis, Fever, Night sweats, Lupus, Cancer
- **Other Names**: 
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Bie Jia** | Turtle shell (Chinese soft-shell turtle carapace) | *King* | 15g | Temp: Cool<br>Taste: Salty (&#x54B8; xi&#xE1;n)<br>Affinity: Liver, Kidneys | Enters deeply into the Yin level to nourish Yin and clear deficiency Heat from within. As a substance from a living creature, it has the unique ability to penetrate the collaterals and search out deeply lodged pathogenic Heat that ordinary Yin-tonifying herbs cannot reach. |
| **Qing Hao** | Sweet wormwood | *King* | 6g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;), Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Liver, Gallbladder, Kidneys | Aromatic, bitter, and cold, it clears Heat and vents lurking pathogenic factors outward from the Yin level to the exterior. Works in tandem with Bie Jia in a complementary 'enter-then-exit' strategy: Bie Jia guides Qing Hao into the deep Yin level, while Qing Hao leads the pathogen outward through the Shaoyang. |
| **Sheng Di Huang (Raw Rehmannia Root)** |  | *Deputy* | 12g | Temp: <br>Taste: <br>Affinity:  | Sweet and cold, it nourishes Yin and cools the Blood, reinforcing Bie Jia in clearing deficiency Heat from the collaterals and replenishing damaged fluids. |
| **Zhi Mu** | Anemarrhena rhizome | *Deputy* | 6g | Temp: Cold<br>Taste: Bitter (&#x82E6; k&#x1D4;), Sweet (&#x7518; g&#x101;n)<br>Affinity: Lungs, Stomach, Kidneys | Bitter and cold, it clears Heat and nourishes Yin. Assists the King herbs in clearing residual Heat and generating fluids, helping to break the cycle where Heat consumes Yin and Yin deficiency generates more Heat. |
| **Mu Dan Pi** | Tree peony root bark | *Assistant* | 9g | Temp: Slightly Cool<br>Taste: Bitter (&#x82E6; k&#x1D4;), Acrid / Pungent (&#x8F9B; x&#x12B;n)<br>Affinity: Heart, Liver, Kidneys | Cools the Blood and drains lurking fire from the Blood level. Assists Qing Hao in venting Heat outward, providing an 'internal clearing, external venting' effect that addresses Heat lodged in both the Qi and Blood aspects of the Yin level. |

---

## Scientific Research

1. Literature review and case report on Qing-Hao-Bie-Jia Decoction for lung cancer-related fever (2026) (*Chu XG, Zhang WH, Luo B, Yang F, Lv WM, Zhou SY, Han ZX. Frontiers in Medicine. 2026;13:1717877.*)
...
- **Best Time to Take**: Twice daily, taken warm, ideally in the late morning and late afternoon/early evening (before the typical onset of nighttime fever).
- **Typical Duration**: Typically prescribed for 1 to 3 weeks, reassessed by a practitioner as symptoms evolve. Longer courses may be needed for chronic low-grade fevers.
- **Dietary Advice**: While taking this formula, avoid spicy, greasy, and fried foods, which can generate internal Heat and counteract the formula's cooling effects. Alcohol should also be avoided as it produces Heat and consumes Yin. Light, easily digestible foods are preferable. Foods that gently nourish Yin are supportive, such as pear, lotus root, lily bulb, mung bean, tofu, and clear soups. Cold and raw foods should be eaten in moderation to avoid burdening the Spleen, especially in patients who already have weak digestion.

---
*Original URL: [https://www.meandqi.com/knowledge-base/formulas/qing-hao-bie-jia-tang](https://www.meandqi.com/knowledge-base/formulas/qing-hao-bie-jia-tang)*
