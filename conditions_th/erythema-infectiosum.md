...
**คำอ่านพินอิน**: chuán rǎn xìng hóng bān | **ประเภท**: Condition | **หมวดหมู่**: การติดเชื้อไวรัส, สภาพผิว, สุขภาพเด็กและทารกแรกเกิด  
**ชื่อเรียกอื่นๆ**:  | **บริเวณร่างกาย**: 

---

## บทสรุปย่อ (Preview Summary)
ผื่นตบแก้มเป็นสัญญาณที่ชัดเจนของลม-ความร้อนที่ติดอยู่ในปอดและผิวหนัง และด้วยสมุนไพรและการฝังเข็มที่เหมาะสม เด็กส่วนใหญ่จะรู้สึกดีขึ้นภายในไม่กี่วัน มักจะหาย...
...
> 
> **คำแปลภาษาอังกฤษ**: "For wind-warmth, warm-heat, pestilential warmth, and winter-warmth at the initial stage with aversion to wind and cold, Cinnamon Twig Decoction governs; but if there is heat without aversion to cold and thirst, the pungent-cool balanced formula Yin Qiao San governs."
> 
> — แหล่งที่มา: *Wen Bing Tiao Bian (Systematized Identification of Warm Diseases)  ,  Chapter 1, Article 4 									·
More references*
...
- **สัญญาณและอาการทางคลินิก (Clinical Signs)**: Slapped cheek rash (bright red cheeks), Lacy, net-like rash on trunk and limbs, Mild fever with slight chills, Sore or scratchy throat, Cough with yellow phlegm, Thirst or dry mouth, Red tip of the tongue
- **สิ่งกระตุ้นให้อาการแย่ลง (Worse with)**: Spicy, greasy foods, Wind or draft exposure, Overexertion or lack of rest, Hot, stuffy environments, Alcohol or coffee
- **สิ่งช่วยให้อาการดีขึ้น (Better with)**: Rest and sleep, Cool drinks (chrysanthemum tea), Light, easily digestible foods, Staying in a cool, ventilated room, Gentle sweating (without chills)
- **กลไกการเกิดอาการ (Why this happens)**:
  In TCM, the Lungs govern the skin and breathing. When Wind-Heat invades through the nose and mouth, it first attacks the Lungs, disrupting their ability to spread defensive Qi to the surface. The heat fights with the body's defenses at the skin, causing the bright red slapped-cheek rash and the lacy body rash. The mild fever, sore throat, and cough are signs that Lung Qi is not descending properly.
- **ลักษณะลิ้นและชีพจร (Tongue & Pulse)**: Tongue: red tip, thin yellow coating, body slightly red. Pulse: floating and rapid (浮数 fú shuò).
- **อธิบายสิ่งกระตุ้นและการทุเลาอาการ (Triggers & Relief Explanation)**: Wind-Heat is an exterior pathogen, so rest and cooling foods help the body's defensive Qi push it out and clear the heat. Spicy and greasy foods add internal heat, making the rash and fever worse. Wind exposure invites more pathogen, while overexertion depletes Qi, weakening the body's resistance. Keeping cool and drinking fluids supports the Lung's function of moistening the skin and throat.
- **คำแนะนำด้านอาหารและการดำเนินชีวิต (Diet & Lifestyle)**: Rest is essential to allow the body's defensive Qi to fight the pathogen. Keep the room well-ventilated but avoid drafts. Dress in light, breathable clothing.
Drink plenty of fluids: water, chrysanthemum tea, or pear juice. Eat light, cooling foods like congee, steamed vegetables, and fruit. Avoid spicy, greasy, or fried foods, as well as alcohol and coffee, which can worsen heat.

#### ตำรับยาที่แนะนำ (Recommended Formulas)
| ชื่อตำรับยา | คำแปลชื่อ | สรรพคุณและลักษณะทางเภสัชวิทยา | คำอธิบาย |
| :--- | :--- | :--- | :--- |
| **[Yin Qiao San](https://www.meandqi.com/knowledge-base/formulas/yin-qiao-san)** | Honeysuckle and Forsythia Powder &#xB7; Q&#x12B;ng dynasty, 1798 CE | Cool, Disperses Wind-Heat, Clears Heat, Resolves Toxicity | The classic formula for Wind-Heat invading the Lungs; it releases the exterior, clears heat, and relieves the sore throat and rash. |
...
| :--- | :--- | :--- | :--- |
| **[Jin Yin Hua](https://www.meandqi.com/knowledge-base/herbs/jin-yin-hua)** | Honeysuckle flower |  | Clears heat and resolves toxicity, especially good for skin rashes. |
| **[Lian Qiao](https://www.meandqi.com/knowledge-base/herbs/lian-qiao)** | Forsythia fruit |  | Clears heat and dissipates nodules, helps the rash subside. |
| **[Bo He](https://www.meandqi.com/knowledge-base/herbs/bo-he)** | Peppermint herb |  | Releases the exterior, relieves sore throat, and guides herbs to the head. |
...
| :--- | :--- | :--- | :--- | :--- |
| **LU-7** | [Lieque LU-7](https://www.meandqi.com/knowledge-base/acupuncture/lung-meridian/lieque-lu-7) | Li&#xE8; qu&#x113; | Descends and diffuses the Lung Qi, Expels Wind from the Exterior | Diffuses Lung Qi and releases the exterior, easing cough and sore throat. |
| **LI-4** | [Hegu LI-4](https://www.meandqi.com/knowledge-base/acupuncture/large-intestine-meridian/hegu-li-4) | H&#xE9; G&#x1D4; | Expels Exterior Wind, Regulates Defensive Qi | Clears heat and alleviates pain; especially useful for facial rashes. |
| **GB-20** | [Fengchi GB-20](https://www.meandqi.com/knowledge-base/acupuncture/gall-bladder-meridian/fengchi-gb-20) | F&#x113;ng Ch&#xED; | Subdues Liver Yang, Expels Exterior or Interior Wind | Expels Wind-Heat and clears the head, reducing fever and headache. |
| **LI-11** | [Quchi LI-11](https://www.meandqi.com/knowledge-base/acupuncture/large-intestine-meridian/quchi-li-11) | Q&#x16B; Ch&#xED; | Clears Heat, Cools the Blood | Clears heat and cools the blood, benefiting skin conditions. |

---

## คำถามที่พบบ่อย (Frequently Asked Questions)
### How quickly can TCM help my child's fifth disease?
...
### Is acupuncture safe for children with this rash?
...
### Can herbs be given alongside acetaminophen or ibuprofen?
...
### Do I need to change my child's diet during fifth disease?
...
### Can adults get fifth disease and be treated with TCM?
...
*ลิงก์ข้อมูลต้นฉบับภาษาอังกฤษ: [Me & Qi Original Page](https://www.meandqi.com/knowledge-base/conditions/erythema-infectiosum)*